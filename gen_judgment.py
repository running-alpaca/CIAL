"""
Usage:
python gen_judgment.py --model-list llava-1.5-7b --parallel [num-concurrent-api-call] --mode [single|pairwise-baseline|pairwise-all]
python gen_judgment.py --model-list llava-1.5-7b --bench-name Activity --parallel 1 --mode single
...
if __name__ == "__main__":
    ...
    answer_dir = f"{data_folder}/{args.bench_name}/final_answer"
