...
prompt_caption="""
<image> Describe this image in the first-person perspective, along with employing object detection techniques.
"""
...
class TestMplugOwl:
    ...
    @torch.no_grad()
    def generate(self, image, question,max_new_tokens=256, planning=False,caption=False):

        if caption:
            prompts = prompt_caption    #做caption时使用，记得删除
        else:
            if planning:
