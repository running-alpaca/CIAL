...
class VideoLLaVA:
    ...
    def generate_description(self, num_frames=8, max_length=80):
        ...
        clip=Image.open(self.video_path)
...
if __name__ == "__main__":
    model_path = "./VLMs/Video-LLaVA-7B-hf/"
    # video_path = "/disks/disk5/private/yyyou/InternLM-XComposer-main/examples/liuxiang.mp4"
    video_path = "./data/Activity/images/4.jpg"

    question = "USER: <video>Describe this image. ASSISTANT:"
