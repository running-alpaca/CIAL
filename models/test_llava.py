...
class TestLLaVA:
    def __init__(self, size='7b', device=None):
        ...
        self.conv = get_conv("conv_llava_v1")
    ...
    @torch.no_grad()
    def do_generate(self, prompts, images, dtype=torch.float16, temperature=0.2, max_new_tokens=30, stop_str=None, keep_aspect_ratio=True):
