...
def get_model(model_name, device=None):
    ...
    if model_name == 'blip2-7b':
        ...
        from .test_minigpt4_caption_ret import TestMiniGPT4
        return TestMiniGPT4(device=device)
    elif model_name == 'minigpt4-13b':
        # from .test_minigpt4_1 import TestMiniGPT4
        from .test_minigpt4_caption_ret import TestMiniGPT4
        return TestMiniGPT4(device=device)
    elif model_name == 'mPLUG-Owl'.lower():
        # from .test_mplug_owl import TestMplugOwl
        from .test_mplug_owl_caption_ret import TestMplugOwl
        return TestMplugOwl(device)
    elif model_name == 'mPLUG-Owl2'.lower():
        # from .test_mplug_owl2 import TestMplugOwl
        from .test_mplug_owl2_caption_ret import TestMplugOwl
        return TestMplugOwl(device)
    elif model_name == 'Otter-Image'.lower():
        from .test_otter_image_caption_ret import TestOtterImage
        ...
        # from .test_otter_vid import TestOtterImage
        from .test_otter_image import TestOtterImage
        return TestOtterImage(name='video', device=device)
    elif model_name == 'InstructBLIP-7b'.lower():
        from .test_blip2 import TestBlip2
        return TestBlip2(device=device, config_path='./blip_configs/blip2_instruct_vicuna7b.yaml', name='blip2_vicuna_instruct', model_type='vicuna7b')
    elif model_name == 'InstructBLIP-13b-flant5'.lower():
        from .test_blip2 import TestBlip2
        return TestBlip2(device=device, config_path='./blip_configs/blip2_instruct_flant5xxl.yaml', name='blip2_t5_instruct', model_type='flant5xxl')
        ...
        # from .test_llava2 import TestLLaVA2
        from .test_llava_caption_ret import TestLLaVA2
    ...
    elif model_name == 'LLaVA-1.6-7b'.lower():
        # from .test_llava3 import TestLLaVA2
        from .test_llava3_caption_ret import TestLLaVA2
        return TestLLaVA2(size='1.6-7b', device=device) 
    elif model_name == 'LLaVA-1.6-13b'.lower():
        # from .test_llava3 import TestLLaVA2
        from .test_llava3_caption_ret import TestLLaVA2
        return TestLLaVA2(size='1.6-13b', device=device)     
        ...
        from .test_pandagpt_caption_ret import TestPandaGPT
